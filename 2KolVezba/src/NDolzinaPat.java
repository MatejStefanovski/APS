...
public class NDolzinaPat {
    ...
    static int countPaths(AdjacencyListGraph<Integer> graph, int startVertex, int targetSum) {
        return dfs(graph, startVertex, startVertex, targetSum);
    }

    static int dfs(AdjacencyListGraph<Integer> graph, int current, int currentSum, int targetSum) {
        ...
        for (Integer neighbor : graph.getNeighbors(current)) {
            count += dfs(graph, neighbor, currentSum + neighbor, targetSum);
        }
        return count;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countPaths(graph, startVertex, length));
    }
}
